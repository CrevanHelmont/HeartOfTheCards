...
public class CardHolder extends Item {
    ...
    {
        tooltip.add(Text.translatable("item.arcproj.card_holder.tooltip").formatted(Formatting.GOLD));
        tooltip.add(Text.translatable("item.arcproj.card_holder.tooltip2").formatted(Formatting.GOLD));
    }
}
