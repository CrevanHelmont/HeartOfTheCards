...
public class CardHolderInventory implements Inventory, CardHolderInvInterface{
    ...
    public CardHolderInventory(NbtCompound items_tag, Hand hand, PlayerEntity player)
    {
        this.hand = hand;
        this.player = player;
    ...
    public void fromTag(NbtCompound tag)
    {
        ...
        this.inventory_height = tag.contains("inventory_height") ? tag.getInt("inventory_height") : 3;
    ...
    public void onClose(PlayerEntity player)
    {
        ...
        player.getStackInHand(hand).getNbt().put("arcproj", toTag());
        player.playSound(SoundEvents.BLOCK_WOOL_PLACE, SoundCategory.PLAYERS, 1f, 1f);
    }
}
